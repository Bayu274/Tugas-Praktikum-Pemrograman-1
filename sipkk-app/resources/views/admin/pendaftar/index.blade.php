...
<head>
    ...
    <title>Data Pendaftar - Admin SIPKK UNS</title>
    ...
    <style>
        ...
        .nav-item.admin-active > .nav-link {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pendaftar Kegiatan</h1>
                    </div>
                    
                    <p class="lead">Halaman ini menampilkan semua pendaftaran dari seluruh kegiatan.</p>
                    <hr class="my-4">
                    
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">Tabel Pendaftar</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        @forelse ($pendaftar as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="badge bg-primary text-white">Terdaftar</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    {{-- Tombol untuk melihat detail pendaftaran atau membatalkan --}}
                                                    <a href="#" class="btn btn-info btn-sm">Detail</a>
                                                </td>
                                            </tr>
                                        @empty 
                                            <tr class="text-center">
                                                <td colspan="7">Belum Ada Data Pendaftar Kegiatan yang Tersedia.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
