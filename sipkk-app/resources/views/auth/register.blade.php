...
<head>
    ...
    <title>Register - Sistem Kegiatan UNS</title>
    ...
    <style>
        ...
        /* 2. BACKGROUND GAMBAR STATIS & OVERLAY */
        body {
            min-height: 100vh;
            position: relative;
            overflow-x: hidden; 
            
            /* PENTING: Hapus padding dan gunakan Flexbox */
            padding: 0; 
            display: flex;
        ...
        /* 3. CARD GLASSMORPHISM (form-signin) */
        .form-signin {
            max-width: 400px; 
...
<main class="form-signin w-100">
    <form method="POST" action="{{ route('register') }}">
        ...
        <h1 class="h3 mb-1 fw-bold">BUAT AKUN BARU</h1>
        <p class="text-muted mb-4">Daftarkan diri Anda ke Sistem Informasi Kegiatan Kampus UNS</p>
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingName" placeholder="Nama Lengkap" name="name" value="{{ old('name') }}" required autofocus autocomplete="name">
        ...
        <div class="form-floating mb-4">
            <input type="password" class="form-control" id="floatingPasswordConfirmation" placeholder="Konfirmasi Password" name="password_confirmation" required autocomplete="new-password">
            <label for="floatingPasswordConfirmation">Konfirmasi Password</label>
        </div>
        
        {{-- CONTAINER SUDAH PUNYA AKUN & REGISTER --}}
        <div class="d-flex justify-content-between align-items-center mt-3">
            {{-- SUDAH PUNYA AKUN --}}
            <div class="text-start">
                <p class="text-white d-inline mb-0">Sudah Punya Akun? </p><a class="text-decoration-none text-link d-inline" href="{{ route('login') }}">Masuk.</a>
            </div>
            
            {{-- TOMBOL REGISTER --}}
            <button class="btn btn-lg btn-primary shadow-lg fw-bold" type="submit">
                REGISTER
            </button>
        </div>
